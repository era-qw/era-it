...
const waitForFonts = async (font: string) => {
  ...
  try {
    ...
    /* шрифт мог не загрузиться — рисуем системным */
  }
...
/**
 * Заголовок из частиц: текст собирается из разлетевшихся точек,
 * при наведении частицы разбегаются, в покое слегка дрейфуют.
 */
export default function ParticleText({
  ...
  useEffect(() => {
    ...
    /* пауза, когда заголовок вне вьюпорта */
    let visible = true
  ...
  return (
    <div ref={containerRef} className={`particle-text ${className}`} style={style} aria-hidden="true">
