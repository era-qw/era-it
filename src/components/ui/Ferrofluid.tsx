...
/**
 * Фоновый WebGL-эффект «феррожидкости»: светящиеся контурные линии,
 * текущие потоком; реагируют на курсор (магнитное пятно).
 */
export default function Ferrofluid({
  ...
  useEffect(() => {
    ...
    /* слушаем на window: жидкость реагирует на курсор, даже когда
       над canvas лежит контент секции */
