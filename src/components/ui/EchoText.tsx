...
type EchoEase = 'linear' | 'ease-out' | 'ease-in-out' | 'snappy'
type EchoMode = 'both' | 'entrance' | 'pointer'
...
/**
 * Текст со «шлейфом»: несколько полупрозрачных копий отстают от основной
 * при появлении и при движении курсора рядом, создавая эффект эха.
 */
